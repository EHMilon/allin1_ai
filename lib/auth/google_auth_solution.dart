...
import 'package:allin1_ai/auth/web_view_screen.dart'; // Import WebViewScreen
...
class GoogleAuthSolution {
  ...
  handleGoogleSignIn(
    ...
    // Show options dialog
    await _showSignInOptionsDialog(
      context,
      targetUrl,
    );
  }
                          ...
                          MaterialPageRoute(
                            builder:
                                (
                                  ...
                                  url: targetUrl,
                                  title: 'Google Service', // Or dynamically set a better title
                                ),
                          ),
                        );
                      },
  ...
  _openInCustomTab(
    ...
    try {
      ...
      if (context.mounted) {
        _showInfoSnackBar(
          context,
          'Opened in secure browser tab. Return to app when done.',
        );
      }
    } catch (
      e
      ...
      if (context.mounted) {
        _showErrorSnackBar(
          context,
          'Failed to open secure tab. Trying external browser...',
        );
        await _openInExternalBrowser(
          url,
        );
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const Text(
                    'You can now access Google services. Would you like to open the service in your browser?',
                  ),
                ],
              ),
              actions: [
            ...
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  ...
                  const Text(
                    '• Open in external browser (most reliable)',
                  ),
                  const Text(
                    '• Use secure browser tab',
                  ),
                  const Text(
